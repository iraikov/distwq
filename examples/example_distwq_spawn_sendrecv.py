...
if __name__ == '__main__':
    if distwq.is_controller:
        distwq.run(fun_name="main", verbose=True, spawn_workers=True, nprocs_per_worker=nprocs_per_worker, collective_mode="sendrecv")
    else:
        distwq.run(verbose=True, spawn_workers=True, nprocs_per_worker=nprocs_per_worker, collective_mode="sendrecv")
